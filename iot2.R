...
#Plot
par(mar = c(5,5,2,5))
plot(mean1segserver_e_fs$time[1:300], mean1segserver_e_fs$size[1:300], type="l", col="blue", main = "Application H1 (SH) - default", lwd=2, xlim = c(1,300), ylab="Throughput (bps)", ylim = c(0,350000), xlab = "time(s)")
...
#Plot
par(mar = c(5,5,2,5))
plot(mean1segserver_g_fs$time[1:300], mean1segserver_g_fs$size[1:300], type="l", col="blue", main = "Application H2 (GI) - default", lwd=2, xlim = c(1,300), ylab="Throughput (bps)", ylim = c(0,350000), xlab = "time(s)")
...
#Plot
par(mar = c(5,5,2,5))
plot(mean1segserver_e2_fs$time[1:300], mean1segserver_e2_fs$size[1:300], type="l", col="blue", main = "Application H3 (IM) - default", lwd=2, xlim = c(1,300), ylab="Throughput (bps)", ylim = c(0,250000), xlab = "time(s)")
